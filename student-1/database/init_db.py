    ...
    with get_connection() as conn:
        ...
        products = [
            ...
            (
                ...
                "https://placehold.co/400x300?text=Free+Dishwasher",
            ),
            (
                "HeatWave Gas Cooktop 90",
                "HeatWave",
                5,
                849.00,
                8,
                "Five-burner gas cooktop with a wok burner.",
                "https://placehold.co/400x300?text=Gas+Cooktop",
            ),
            (
                "QuickChef Solo 20",
                "QuickChef",
                ...
                149.00,
                24,
                "Simple 20 L microwave for everyday reheating.",
                "https://placehold.co/400x300?text=Solo+Microwave",
            ),
            (
                "DustDevil Stick V8",
                "DustDevil",
                ...
                349.00,
                17,
                "Cordless stick vacuum for hard floors and carpets.",
                "https://placehold.co/400x300?text=Stick+Vac",
            ),
            (
                "PureAir Bedroom 150",
                "PureAir",
                ...
                299.00,
                15,
                "Quiet bedroom purifier with a night mode.",
                "https://placehold.co/400x300?text=Bedroom+AP",
            ),
            (
                "BaristaOne Pod Mini",
                "BaristaOne",
                ...
                179.00,
                26,
                "Compact pod machine for a quick weekday coffee.",
                "https://placehold.co/400x300?text=Pod+Mini",
            ),
            (
                "HydroLux Instant 27",
                "HydroLux",
                ...
                389.00,
                18,
                "27 kW instant gas water heater for one bathroom.",
                "https://placehold.co/400x300?text=Instant+HW",
            ),
            (
                "HydroLux Storage 250",
                "HydroLux",
                10,
                869.00,
                7,
        ...
        specs = [
            ...
            (13, "Place Settings", "15"),
            (13, "Water Usage", "11 L per cycle"),
            (13, "Noise Level", "46 dB"),
            (14, "Burners", "5"),
            (14, "Fuel", "Natural gas"),
            (14, "Width", "90 cm"),
            (15, "Capacity", "20 L"),
            (15, "Power", "800 W"),
            (15, "Functions", "Reheat, defrost"),
            (16, "Runtime", "45 min"),
            (16, "Suction", "2200 Pa"),
            (16, "Dustbin", "0.6 L"),
            (17, "Coverage", "22 sqm"),
            (17, "Filter", "HEPA H13"),
            (17, "Noise Level", "22 dB"),
            (18, "Pod Type", "Compatible capsules"),
            (18, "Water Tank", "0.8 L"),
            (18, "Heat-up", "25 seconds"),
            (19, "Output", "27 kW"),
            (19, "Fuel", "Natural gas"),
            (19, "Flow Rate", "16 L per minute"),
            (20, "Capacity", "250 L"),
            (20, "Fuel", "Electric"),
            (20, "Recovery", "4 hours"),
        ]
